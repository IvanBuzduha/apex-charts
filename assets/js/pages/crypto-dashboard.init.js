...
areaSparkline3Colors && (options = {
    series: [{
        name: "USD",
        data: [1600, 2000, 2500, 3000, 3100, 4000, 3100]
    }],
    chart: {
        type: "area",
        height: 40,
...
var options, chart, overviewTimelineColors = getChartColorsArray("overview-chart-timeline");
overviewTimelineColors && (options = {
    series: [{
        name: "BTC",
        data: [
            [13273596e5, 30.95],
